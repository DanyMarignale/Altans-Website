        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="nom" className="block mb-2 text-foreground">
                  Nom complet *
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="telephone" className="block mb-2 text-foreground">
                  Téléphone
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="sujet" className="block mb-2 text-foreground">
                  Domaine concerné *
                </label>
                <select
                  id="sujet"
              ...
              <button
                type="submit"
                className="w-full bg-primary text-primary-foreground px-6 py-4 rounded-lg hover:bg-primary/90 transition-colors flex items-center justify-center gap-2"
              >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:dm@altans.fr" className="text-foreground hover:text-primary transition-colors">
                      dm@altans.fr
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+33622264965" className="text-foreground hover:text-primary transition-colors">
                      06.22.26.49.65
                    </a>
                  </div>
                </div>
