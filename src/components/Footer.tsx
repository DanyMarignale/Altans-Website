...
export function Footer() {
  ...
  return (
    <footer className="bg-white text-[#001F54] py-16 px-4 sm:px-6 lg:px-8 border-t border-gray-200">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Navigation */}
          <div>
            <h4 className="mb-4 text-[#001F54]">Navigation</h4>
            <ul className="space-y-2">
              <li>
                <button 
                  onClick={() => scrollToSection('accueil')}
                  className="text-[#001F54] hover:text-[#001F54]/70 transition-colors"
                >
                  Accueil
                </button>
              </li>
          ...
          {/* Expertises */}
          <div>
            <h4 className="mb-4 text-[#001F54]">Nos expertises</h4>
            <ul className="space-y-2 text-[#001F54]">
        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-[#001F54] text-sm">
              © {new Date().getFullYear()} ALTANS Avocats. Tous droits réservés.
            </p>
            <div className="flex gap-6 text-sm">
              <a href="#" className="text-[#001F54] hover:text-[#001F54]/70 transition-colors">
                Mentions légales
              </a>
              <a href="#" className="text-[#001F54] hover:text-[#001F54]/70 transition-colors">
